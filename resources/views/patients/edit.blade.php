                                                ...
                                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                    ...
                                                    <div class="relative">
                                                        <select name="service" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="inputService">
                                                            ...
                                                            <option value="Dental Surgery" {{ $patient->service == 'Dental Surgery' ? 'selected' : '' }}>Dental Surgery</option>
                                                            <option value="Dental Cleaning" {{ $patient->service == 'FemaleDental Cleaning' ? 'selected' : '' }}>Dental Cleaning</option>
                                                            <option value="Check-Up" {{ $patient->service == 'Check-Up' ? 'selected' : '' }}>Check-Up</option>
                                                        </select>
