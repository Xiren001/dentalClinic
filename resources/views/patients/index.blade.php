                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-8">
                        <div class="flex justify-between items-center mb-4">
                            <a href="{{ route('patients.create') }}" class="bg-blue-500 text-black py-2 px-4 rounded hover:bg-blue-700">
                        ...
                        <table class="table-auto w-full border-collapse">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b text-gray-700">
                                    ...
                                    <td class="p-2 text-center">
                                        <img src="/images/{{ $patient->image }}" width="50px" height="50px" class="rounded">
                                    </td>
                                    <td class="p-2 text-center">{{ $patient->firstname }}</td>
                                    <td class="p-2 text-center">{{ $patient->middlename }}</td>
                                    <td class="p-2 text-center">{{ $patient->lastname }}</td>
